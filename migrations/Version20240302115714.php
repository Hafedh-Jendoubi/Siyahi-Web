 ...
 */
final class Version20240302115714 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD email VARCHAR(180) NOT NULL, ADD roles JSON NOT NULL COMMENT \'(DC2Type:json)\', ADD password VARCHAR(255) NOT NULL, ADD old_email VARCHAR(255) NOT NULL, ADD activity VARCHAR(1) NOT NULL, DROP role');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD role VARCHAR(15) NOT NULL, DROP email, DROP roles, DROP password, DROP old_email, DROP activity');
    }
}
